...
malloc:
    ...
    addi    a1, a0, 0
    # a0 = 9 -> Stores a pointer to a block of memory containing n additional bytes in register a0. This pointer is word aligned.
    addi    a0, x0 9
    ecall
    # After the ecall, the address of the allocated memory block will be placed in a0.
    jr  ra